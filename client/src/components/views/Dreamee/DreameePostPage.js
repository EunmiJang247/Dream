  ...
  return (
    ...
    //마이페이지의 내 드림이소개에서 접근한 경우, 수정버튼 안누른경우 
        <Resultdiv>
            ...
            <span style={{marginLeft:'10px', fontWeight: 'bold'}}>사진</span><br />
            {mydreamee.Images &&
                        <img style = {{minWidth:'300px', width:'300px', height:'240px'}}
                            src={`http://localhost:5000/${mydreamee.Images}`} alt="이미지"
                        />
                    }
            <br />
            ...
            <span style={{marginLeft:'10px', fontWeight: 'bold'}}>포트폴리오 웹사이트</span><br />
            {mydreamee.portfolio}<br />

            <span style={{marginLeft:'10px', fontWeight: 'bold'}}>카카오아이디(프로젝트 수락할 경우에만 열람이 가능합니다)</span><br />
            {mydreamee.kakao}<br />

            <span style={{marginLeft:'10px', fontWeight: 'bold'}}>자신에 대한 간략한 설명</span><br />
            {mydreamee.introduce}
    ...
    //마이페이지의 내 드림이소개에서 수정하기 버튼 누른경우
        <Resultdiv>
            ...
            <FileUpload refreshFunction={updateImages} dreameeImages={mydreamee.Images}/>
            ...
            <span style={{marginLeft:'10px', fontWeight: 'bold'}}>지원예정/현재 직군</span><br />
            ...
            { 
                nickname === "" || position === "" || tech === "" || portfolio === "" || kakao === "" || selfintro === "" || Images === "" 
                ?<SubmitButtonDisable>수정완료</SubmitButtonDisable>
                :
                <>
                <SubmitButton onClick={onModifyCompleteHandler}>수정완료</SubmitButton>
                <Link to={{pathname: `/mypage/mydreamee/${userid}`}}><SubmitButton>돌아가기</SubmitButton></Link>
                </>
            }
